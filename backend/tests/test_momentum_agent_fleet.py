...
EXPECTED = {
    ...
    "fleet-qa": "openrouter-muse-spark-contributor",
    "fleet-reliability": "openrouter-muse-spark-contributor",
}
...
def test_momentum_agent_fleet_is_bounded_and_evaluated() -> None:
    ...
    for name in EXPECTED:
        ...
        assert config.model == EXPECTED[name]
    ...
    assert set(execution["roles"]) == EXPECTED.keys()

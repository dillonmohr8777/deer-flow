...
export const zhCN: Translations = {
  ...
  dailyBrief: {
    ...
    kindRunFailed: "运行失败",
    kindDocument: "新增文档",
    kindScheduledSuccess: "定时任务已完成",
    kindScheduledFailed: "定时任务失败",
    waitingInterrupted: "被中断，需要你决定",
    waitingClarification: "等待你的回复",
    writeItUp: "让 Momo 帮我写一份",
    writeItUpIntro: "帮我把今天的早报整理成一份简短易读的笔记。内容如下：",
    writeItUpClients: "客户：",
    writeItUpActivity: "新动态：",
    writeItUpDue: "今天到期：",
    writeItUpWaiting: "等我处理：",
    writeItUpNothing: "暂无其他内容。",
  },
};

...
export const enUS: Translations = {
  ...
  dailyBrief: {
    title: "Your morning",
    clientsLabel: "Your clients",
    loading: "Catching up on the morning...",
    error: "This morning's brief didn't load. Try refreshing.",
    emptyTitle: "Nothing moved overnight.",
    emptyBody: "Enjoy the coffee.",
    activityHeading: "What moved",
    dueHeading: "Due today",
    waitingHeading: "Waiting on you",
    untitledChat: "Untitled chat",
    kindThread: "New chat",
    kindRunSuccess: "Update",
    kindRunFailed: "Failed",
    kindDocument: "Document added",
    kindScheduledSuccess: "Scheduled task ran",
    kindScheduledFailed: "Scheduled task failed",
    waitingInterrupted: "Interrupted, needs a decision",
    waitingClarification: "Waiting on your answer",
    writeItUp: "Have Momo write it up",
    writeItUpIntro:
      "Turn today's brief into a short, readable note for me. Here's what's in it:",
    writeItUpClients: "Clients:",
    writeItUpActivity: "What moved:",
    writeItUpDue: "Due today:",
    writeItUpWaiting: "Waiting on me:",
    writeItUpNothing: "Nothing else to report.",
  },
};

...
Never edit implementation files to make checks pass, access secrets, mutate production, send messages, spend funds, or widen access without explicit approval. Report failures with exact file, check, and reproduction.
